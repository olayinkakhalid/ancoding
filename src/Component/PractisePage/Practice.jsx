    ...
    <div className="w-full">
      ...
      <div className="text-center space-y-2 md:space-y-3 py-4 md:py-6">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-6 md:gap-12">
          <button className="bg-green-500 w-20 h-10 text-white font-bold shadow-md">
            Start
          </button>

          <button className="relative px-6 py-2 font-semibold rounded-xl overflow-hidden group bg-white ">
          ...
          <button className="relative px-6 py-2 font-semibold rounded-xl overflow-hidden bg-white border border-green-500 text-green-600 group">
